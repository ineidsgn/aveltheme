 ...
 */
function orbisius_ct_distrikt_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_distrikt_parent_style';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_distrikt_child_theme_enqueue_styles' );


function theme_add_bootstrap() {
	wp_enqueue_style( 'bootstrap-css', get_stylesheet_directory_uri() . '/bootstrap/css/bootstrap.min.css' );
	wp_enqueue_style( 'fa-css', get_stylesheet_directory_uri() . '/font-awesome/css/font-awesome.min.css' );
	wp_enqueue_style( 'imgrotator-css', get_stylesheet_directory_uri() . '/rotating/imagerotator/html/css/basic.css' );
	...
	wp_enqueue_script('imgrotator', get_stylesheet_directory_uri() . '/rotating/imagerotator/html/js/imagerotator.js', array('jquery'), time(), true );

	wp_register_script( 'avel-js', get_stylesheet_directory_uri() . '/scripts.js', array('jquery','imgrotator'), time(), true );
	$params = array(
		'ajaxurl' => admin_url('admin-ajax.php'),
		'ajax_nonce' => wp_create_nonce('avel-ajax-safe'),
		'themeurl' => get_stylesheet_directory_uri()
	);
	wp_localize_script( 'avel-js', 'localization', $params );

	wp_enqueue_script( 'avel-js' );
...
register_nav_menus( array(
	'footer_1' => __( 'Footer 1', 'aveltheme' ),
	'footer_2'  => __( 'Footer 2', 'aveltheme' ),
) );